...
"""
    ...
    for p in printings:
        ...
        if recv:
            play_sig = f"func ({recv} {sname}) Play(s *card.TurnState, {self_name} *card.PlayedCard) int"
        else:
            play_sig = f"func ({sname}) Play(s *card.TurnState, {self_name} *card.PlayedCard) int"
