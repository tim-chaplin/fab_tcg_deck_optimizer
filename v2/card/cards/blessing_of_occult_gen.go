...
func (BlessingOfOccultRed) Cost(card.GameEngine) int           { return 1 }
...
func (BlessingOfOccultYellow) Cost(card.GameEngine) int           { return 1 }
...
func (BlessingOfOccultBlue) Cost(card.GameEngine) int           { return 1 }
