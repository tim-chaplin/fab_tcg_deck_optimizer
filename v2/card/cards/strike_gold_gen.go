...
func (StrikeGoldRed) Cost(card.GameEngine) int           { return 0 }
...
func (StrikeGoldYellow) Cost(card.GameEngine) int           { return 0 }
...
func (StrikeGoldBlue) Cost(card.GameEngine) int           { return 0 }
