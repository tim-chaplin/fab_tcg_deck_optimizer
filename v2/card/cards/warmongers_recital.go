...
func warmongersRecitalPlay(ge card.GameEngine, l card.Logger, self *card.CardState, source card.Card, n int) {
...
func (c WarmongersRecitalRed) Play(ge card.GameEngine, l card.Logger, self *card.CardState) {
	warmongersRecitalPlay(ge, l, self, c, 3)
}

func (c WarmongersRecitalYellow) Play(ge card.GameEngine, l card.Logger, self *card.CardState) {
	warmongersRecitalPlay(ge, l, self, c, 2)
}

func (c WarmongersRecitalBlue) Play(ge card.GameEngine, l card.Logger, self *card.CardState) {
	warmongersRecitalPlay(ge, l, self, c, 1)
}
