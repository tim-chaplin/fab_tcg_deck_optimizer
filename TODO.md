...
- **Life-gain effects are credited 1-to-1 with damage** when the trigger fires unconditionally
  ...
  gain on leave, Fiddler's Green's gain on defense). Fyendal's Fighting Spirit's less-life
  gate and the Clearwater / Restvine / Sapwood Elixir trio (Bloodrot Pox / Inertia / Frailty
  riders, gated on status tokens we don't track) still default off.
