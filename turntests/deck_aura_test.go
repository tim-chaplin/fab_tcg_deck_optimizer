...
func TestEvalTwoTurns_SigilOfFyendalQueuesTrigger(t *testing.T) {
	...
	turn1, turn2 := sim.EvalTwoTurnsForTesting(d, sim.Matchup{IncomingDamage: 0}, nil, []deck.Card{sigil})
...
func TestEvalTwoTurns_BlessingOfOccultCreatesRunesAtStartOfNextTurn(t *testing.T) {
	...
	d := deck.New(heroes.Viserai{}, nil, nil)
	turn1, turn2 := sim.EvalTwoTurnsForTesting(d, sim.Matchup{IncomingDamage: 0}, nil, []deck.Card{blessing, pitch})
...
func TestEvalTwoTurns_MaleficIncantationOncePerTurnLimitsToOneRune(t *testing.T) {
	...
	d := deck.New(heroes.Viserai{}, nil, nil)
	turn1, turn2 := sim.EvalTwoTurnsForTesting(d, sim.Matchup{IncomingDamage: 0}, nil, []deck.Card{malefic, hocus})
...
func TestEvalTwoTurns_RunebloodIncantationTicksAcrossTurns(t *testing.T) {
	...
	pitch := testutils.BluePitch{}
	d := deck.New(heroes.Viserai{}, nil, nil)
	turn1, turn2 := sim.EvalTwoTurnsForTesting(d, sim.Matchup{IncomingDamage: 0}, nil, []deck.Card{runeblood, pitch})
