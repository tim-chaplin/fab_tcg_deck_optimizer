...
func TestHandState_SpringLoadAlonePitchEmptiesHand(t *testing.T) {
	...
	if got := sim.EvalOneTurnForTesting(d, sim.Matchup{IncomingDamage: 0}, gameengine.Spec{}, hand).Value; got != 5 {
...
func TestHandState_BlockerEmptiesHandForSpringLoad(t *testing.T) {
	...
	if got := sim.EvalOneTurnForTesting(d, sim.Matchup{IncomingDamage: 3}, gameengine.Spec{}, hand).Value; got != 7 {
...
func TestHandState_UpcomingChainStepBlocksFirstSpringLoadRider(t *testing.T) {
	...
	if got := sim.EvalOneTurnForTesting(d, sim.Matchup{IncomingDamage: 0}, gameengine.Spec{}, hand).Value; got != 7 {
...
func TestHandState_MidChainDrawBlocksSpringLoadRider(t *testing.T) {
	...
	if got := sim.EvalOneTurnForTesting(d, sim.Matchup{IncomingDamage: 0}, gameengine.Spec{}, hand).Value; got != 6 {
...
func TestHandState_HeldCardBlocksSpringLoadRider(t *testing.T) {
	...
	// review.
	if got := sim.EvalOneTurnForTesting(d, sim.Matchup{IncomingDamage: 0}, gameengine.Spec{}, hand).Value; got != 2 {
...
func TestHandState_DemolitionCrewSeesUncommittedPitchInHand(t *testing.T) {
	...
	if got := sim.EvalOneTurnForTesting(d, sim.Matchup{IncomingDamage: 0}, gameengine.Spec{Arsenal: cards.FlyingHighRed{}}, hand).Value; got != 10 {
