...
func (gs *GameState) CreateItem(source card.Card, tt triggertype.Type, handler func(card.GameEngine, card.Logger, card.Item, *card.CardState, triggertype.Type), oncePerTurn bool, filter func(card.TypeSet) bool) {
