...
// methods — no reference to sim or gameengine, so this file can live in internal/deck (which
...
// one slice. Card is the rich internal/card.Card — sim's formatter / chain runner reads Pitch
