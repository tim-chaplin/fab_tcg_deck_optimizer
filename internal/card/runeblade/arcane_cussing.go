...
func (ArcaneCussingRed) Play(s *card.TurnState) int { return fragileAuraValue(s, 3, false) }
...
func (ArcaneCussingYellow) Play(s *card.TurnState) int { return fragileAuraValue(s, 2, false) }
...
func (ArcaneCussingBlue) Play(s *card.TurnState) int { return fragileAuraValue(s, 1, false) }
