...
func (c AmplifyTheArknightRed) Play(*card.TurnState, *card.PlayedCard) int { return c.Attack() }
...
func (c AmplifyTheArknightYellow) Play(*card.TurnState, *card.PlayedCard) int { return c.Attack() }
...
func (c AmplifyTheArknightBlue) Play(*card.TurnState, *card.PlayedCard) int { return c.Attack() }
