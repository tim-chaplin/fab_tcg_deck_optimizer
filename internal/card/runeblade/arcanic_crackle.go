...
func (c ArcanicCrackleRed) Play(s *card.TurnState, _ *card.PlayedCard) int  { return arcanicCracklePlay(c.Attack(), s) }
...
func (c ArcanicCrackleYellow) Play(s *card.TurnState, _ *card.PlayedCard) int  { return arcanicCracklePlay(c.Attack(), s) }
...
func (c ArcanicCrackleBlue) Play(s *card.TurnState, _ *card.PlayedCard) int   { return arcanicCracklePlay(c.Attack(), s) }
