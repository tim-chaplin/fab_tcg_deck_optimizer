...
func (c RuneFlashRed) Play(*card.TurnState, *card.PlayedCard) int  { return c.Attack() }
...
func (c RuneFlashYellow) Play(*card.TurnState, *card.PlayedCard) int  { return c.Attack() }
...
func (c RuneFlashBlue) Play(*card.TurnState, *card.PlayedCard) int  { return c.Attack() }
