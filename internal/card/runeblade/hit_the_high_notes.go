...
func (c HitTheHighNotesRed) Play(s *card.TurnState, _ *card.PlayedCard) int  { return hitTheHighNotesPlay(c.Attack(), s) }
...
func (c HitTheHighNotesYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return hitTheHighNotesPlay(c.Attack(), s) }
...
func (c HitTheHighNotesBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return hitTheHighNotesPlay(c.Attack(), s) }
