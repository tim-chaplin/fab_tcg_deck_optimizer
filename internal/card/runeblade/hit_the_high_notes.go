...
var hitTheHighNotesTypes = map[string]bool{"Runeblade": true, "Action": true, "Attack": true}
...
func (HitTheHighNotesRed) Types() map[string]bool        { return hitTheHighNotesTypes }
...
func (HitTheHighNotesYellow) Types() map[string]bool       { return hitTheHighNotesTypes }
...
func (HitTheHighNotesBlue) Types() map[string]bool       { return hitTheHighNotesTypes }
