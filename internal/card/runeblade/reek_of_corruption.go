...
func (c ReekOfCorruptionRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return reekOfCorruptionDamage(c.Attack(), s) }
...
func (c ReekOfCorruptionYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return reekOfCorruptionDamage(c.Attack(), s) }
...
func (c ReekOfCorruptionBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return reekOfCorruptionDamage(c.Attack(), s) }
