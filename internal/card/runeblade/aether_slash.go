...
func (c AetherSlashRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return aetherSlashPlay(c.Attack(), s) }
...
func (c AetherSlashYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return aetherSlashPlay(c.Attack(), s) }
...
func (c AetherSlashBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return aetherSlashPlay(c.Attack(), s) }
