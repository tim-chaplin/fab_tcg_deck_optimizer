...
func (RunicReapingRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return runicReapingPlay(s, 3) }
...
func (RunicReapingYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return runicReapingPlay(s, 2) }
...
func (RunicReapingBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return runicReapingPlay(s, 1) }
