...
func (SigilOfSufferingRed) Play(s *card.TurnState, _ *card.PlayedCard) int    { return sigilOfSufferingPlay(s) }
...
func (SigilOfSufferingYellow) Play(s *card.TurnState, _ *card.PlayedCard) int    { return sigilOfSufferingPlay(s) }
...
func (SigilOfSufferingBlue) Play(s *card.TurnState, _ *card.PlayedCard) int    { return sigilOfSufferingPlay(s) }
