...
func (c DeathlyDuetRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return deathlyDuetPlay(c.Attack(), s) }
...
func (c DeathlyDuetYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return deathlyDuetPlay(c.Attack(), s) }
...
func (c DeathlyDuetBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return deathlyDuetPlay(c.Attack(), s) }
