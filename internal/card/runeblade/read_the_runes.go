...
func (ReadTheRunesRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return s.CreateRunechants(3) }
...
func (ReadTheRunesYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return s.CreateRunechants(2) }
...
func (ReadTheRunesBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return s.CreateRunechants(1) }
