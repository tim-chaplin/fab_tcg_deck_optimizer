...
func (c SingeingSteelbladeRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return singeingSteelbladePlay(c.Attack(), s) }
...
func (c SingeingSteelbladeYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return singeingSteelbladePlay(c.Attack(), s) }
...
func (c SingeingSteelbladeBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return singeingSteelbladePlay(c.Attack(), s) }
