...
var blessingOfOccultTypes = map[string]bool{"Runeblade": true, "Action": true, "Aura": true}
...
func (BlessingOfOccultRed) Types() map[string]bool    { return blessingOfOccultTypes }
...
func (BlessingOfOccultYellow) Types() map[string]bool   { return blessingOfOccultTypes }
...
func (BlessingOfOccultBlue) Types() map[string]bool   { return blessingOfOccultTypes }
