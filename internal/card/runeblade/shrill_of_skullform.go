...
func (c ShrillOfSkullformRed) Play(s *card.TurnState, _ *card.PlayedCard) int {
...
func (c ShrillOfSkullformYellow) Play(s *card.TurnState, _ *card.PlayedCard) int {
	return shrillPlay(c.Attack(), s)
}
...
func (c ShrillOfSkullformBlue) Play(s *card.TurnState, _ *card.PlayedCard) int {
	return shrillPlay(c.Attack(), s)
}
