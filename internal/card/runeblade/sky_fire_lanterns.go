...
func (c SkyFireLanternsRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return skyFireLanternsPlay(c.Pitch(), s) }
...
func (c SkyFireLanternsYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return skyFireLanternsPlay(c.Pitch(), s) }
...
func (c SkyFireLanternsBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return skyFireLanternsPlay(c.Pitch(), s) }
