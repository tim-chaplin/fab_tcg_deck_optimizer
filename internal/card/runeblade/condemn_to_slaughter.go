...
func (CondemnToSlaughterRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return condemnToSlaughterBonus(s, 3) }
...
func (CondemnToSlaughterYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return condemnToSlaughterBonus(s, 2) }
...
func (CondemnToSlaughterBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return condemnToSlaughterBonus(s, 1) }
