...
func (c HocusPocusRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() + s.CreateRunechant() }
...
func (c HocusPocusYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() + s.CreateRunechant() }
...
func (c HocusPocusBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() + s.CreateRunechant() }
