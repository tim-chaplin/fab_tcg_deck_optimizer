...
func (c VexingMaliceRed) Play(s *card.TurnState, _ *card.CardState) int  { return vexingMalicePlay(c.Attack(), s) }
...
func (c VexingMaliceYellow) Play(s *card.TurnState, _ *card.CardState) int  { return vexingMalicePlay(c.Attack(), s) }
...
func (c VexingMaliceBlue) Play(s *card.TurnState, _ *card.CardState) int  { return vexingMalicePlay(c.Attack(), s) }
