...
func (SutcliffesResearchNotesRed) Play(s *card.TurnState, _ *card.PlayedCard) int   { return sutcliffesResearchNotesPlay(3, s) }
...
func (SutcliffesResearchNotesYellow) Play(s *card.TurnState, _ *card.PlayedCard) int   { return sutcliffesResearchNotesPlay(2, s) }
...
func (SutcliffesResearchNotesBlue) Play(s *card.TurnState, _ *card.PlayedCard) int   { return sutcliffesResearchNotesPlay(1, s) }
