...
func (c SpellbladeStrikeRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() + s.CreateRunechant() }
...
func (c SpellbladeStrikeYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() + s.CreateRunechant() }
...
func (c SpellbladeStrikeBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() + s.CreateRunechant() }
