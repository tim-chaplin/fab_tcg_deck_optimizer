...
func (c SpellbladeAssaultRed) Play(s *card.TurnState, _ *card.CardState) int { return c.Attack() + s.CreateRunechants(2) }
...
func (c SpellbladeAssaultYellow) Play(s *card.TurnState, _ *card.CardState) int { return c.Attack() + s.CreateRunechants(2) }
...
func (c SpellbladeAssaultBlue) Play(s *card.TurnState, _ *card.CardState) int { return c.Attack() + s.CreateRunechants(2) }
