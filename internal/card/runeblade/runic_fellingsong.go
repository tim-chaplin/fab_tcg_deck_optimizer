...
func (c RunicFellingsongRed) Play(*card.TurnState, *card.CardState) int { return c.Attack() + 1 }
...
func (c RunicFellingsongYellow) Play(*card.TurnState, *card.CardState) int { return c.Attack() + 1 }
...
func (c RunicFellingsongBlue) Play(*card.TurnState, *card.CardState) int { return c.Attack() + 1 }
