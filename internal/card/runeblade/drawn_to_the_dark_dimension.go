...
func (c DrawnToTheDarkDimensionRed) Play(s *card.TurnState, _ *card.PlayedCard) int {
	s.DrawOne()
	return c.Attack()
}
...
func (c DrawnToTheDarkDimensionYellow) Play(s *card.TurnState, _ *card.PlayedCard) int {
	s.DrawOne()
	return c.Attack()
}
...
func (c DrawnToTheDarkDimensionBlue) Play(s *card.TurnState, _ *card.PlayedCard) int {
	s.DrawOne()
	return c.Attack()
}
