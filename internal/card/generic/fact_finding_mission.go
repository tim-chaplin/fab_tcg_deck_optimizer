...
func (c FactFindingMissionRed) Play(s *card.TurnState) int { return c.Attack() }
...
func (c FactFindingMissionYellow) Play(s *card.TurnState) int { return c.Attack() }
...
func (c FactFindingMissionBlue) Play(s *card.TurnState) int { return c.Attack() }
