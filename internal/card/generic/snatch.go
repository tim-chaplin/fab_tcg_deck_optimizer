...
func (c SnatchRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return snatchPlay(c.Attack(), s) }
...
func (c SnatchYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return snatchPlay(c.Attack(), s) }
...
func (c SnatchBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return snatchPlay(c.Attack(), s) }
