...
func (StrategicPlanningRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return 0 }
...
func (StrategicPlanningYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return 0 }
...
func (StrategicPlanningBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return 0 }
