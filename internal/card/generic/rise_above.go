...
func (RiseAboveRed) Play(*card.TurnState, *card.PlayedCard) int { return 0 }
...
func (RiseAboveYellow) Play(*card.TurnState, *card.PlayedCard) int { return 0 }
...
func (RiseAboveBlue) Play(*card.TurnState, *card.PlayedCard) int { return 0 }
