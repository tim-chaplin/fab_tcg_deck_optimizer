...
func (c BattlefrontBastionRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c BattlefrontBastionYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c BattlefrontBastionBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
