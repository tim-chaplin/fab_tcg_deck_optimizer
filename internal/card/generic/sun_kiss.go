...
func (SunKissRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return 3 }
...
func (SunKissYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return 2 }
...
func (SunKissBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return 1 }
