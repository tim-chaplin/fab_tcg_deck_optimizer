...
func (c HumbleRed) Play(s *card.TurnState) int { return c.Attack() }
...
func (c HumbleYellow) Play(s *card.TurnState) int { return c.Attack() }
...
func (c HumbleBlue) Play(s *card.TurnState) int { return c.Attack() }
