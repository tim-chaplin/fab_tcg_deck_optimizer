...
func (c RagingOnslaughtRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c RagingOnslaughtYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c RagingOnslaughtBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
