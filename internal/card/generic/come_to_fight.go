...
func (ComeToFightRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return nextAttackActionBonus(s, 3) }
...
func (ComeToFightYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return nextAttackActionBonus(s, 2) }
...
func (ComeToFightBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return nextAttackActionBonus(s, 1) }
