...
func (MoneyWhereYaMouthIsRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return nextAttackActionBonus(s, 3) }
...
func (MoneyWhereYaMouthIsYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return nextAttackActionBonus(s, 2) }
...
func (MoneyWhereYaMouthIsBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return nextAttackActionBonus(s, 1) }
