...
func (c NimbyRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c NimbyYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c NimbyBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
