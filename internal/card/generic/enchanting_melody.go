...
func (EnchantingMelodyRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return setAuraCreated(s) }
...
func (EnchantingMelodyYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return setAuraCreated(s) }
...
func (EnchantingMelodyBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return setAuraCreated(s) }
