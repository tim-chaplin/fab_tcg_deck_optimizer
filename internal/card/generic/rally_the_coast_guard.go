...
func (c RallyTheCoastGuardRed) Play(s *card.TurnState, self *card.CardState) {
...
func (c RallyTheCoastGuardYellow) Play(s *card.TurnState, self *card.CardState) {
	s.ApplyAndLogEffectiveAttack(self)
}
...
func (c RallyTheCoastGuardBlue) Play(s *card.TurnState, self *card.CardState) {
	s.ApplyAndLogEffectiveAttack(self)
}
