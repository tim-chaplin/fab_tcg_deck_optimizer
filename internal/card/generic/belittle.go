...
func (c BelittleRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c BelittleYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c BelittleBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
