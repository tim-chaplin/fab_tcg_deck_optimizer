...
func (c WreckHavocRed) Play(s *card.TurnState) int { return c.Attack() }
...
func (c WreckHavocYellow) Play(s *card.TurnState) int { return c.Attack() }
...
func (c WreckHavocBlue) Play(s *card.TurnState) int { return c.Attack() }
