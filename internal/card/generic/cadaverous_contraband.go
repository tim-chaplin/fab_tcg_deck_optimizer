...
func (c CadaverousContrabandRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c CadaverousContrabandYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c CadaverousContrabandBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
