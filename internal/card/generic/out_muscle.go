...
func (c OutMuscleRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c OutMuscleYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c OutMuscleBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
