...
func frontlineScoutPlay(c card.Card, self *card.PlayedCard) int {
	if self.FromArsenal {
...
func (c FrontlineScoutRed) Play(_ *card.TurnState, self *card.PlayedCard) int { return frontlineScoutPlay(c, self) }
...
func (c FrontlineScoutYellow) Play(_ *card.TurnState, self *card.PlayedCard) int { return frontlineScoutPlay(c, self) }
...
func (c FrontlineScoutBlue) Play(_ *card.TurnState, self *card.PlayedCard) int { return frontlineScoutPlay(c, self) }
