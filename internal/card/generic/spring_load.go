...
func (c SpringLoadRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c SpringLoadYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c SpringLoadBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
