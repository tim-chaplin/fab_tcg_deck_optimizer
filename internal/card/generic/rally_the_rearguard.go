...
func (c RallyTheRearguardRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c RallyTheRearguardYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c RallyTheRearguardBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
