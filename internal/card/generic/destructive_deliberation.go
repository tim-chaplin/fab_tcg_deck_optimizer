...
func (c DestructiveDeliberationRed) Play(s *card.TurnState) int { return c.Attack() }
...
func (c DestructiveDeliberationYellow) Play(s *card.TurnState) int { return c.Attack() }
...
func (c DestructiveDeliberationBlue) Play(s *card.TurnState) int { return c.Attack() }
