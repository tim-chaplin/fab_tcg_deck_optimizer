...
func (FateForeseenRed) Play(*card.TurnState, *card.PlayedCard) int { return 0 }
...
func (FateForeseenYellow) Play(*card.TurnState, *card.PlayedCard) int { return 0 }
...
func (FateForeseenBlue) Play(*card.TurnState, *card.PlayedCard) int { return 0 }
