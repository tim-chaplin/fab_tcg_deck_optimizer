...
func (c WoundingBlowRed) Play(s *card.TurnState) int { return c.Attack() }
...
func (c WoundingBlowYellow) Play(s *card.TurnState) int { return c.Attack() }
...
func (c WoundingBlowBlue) Play(s *card.TurnState) int { return c.Attack() }
