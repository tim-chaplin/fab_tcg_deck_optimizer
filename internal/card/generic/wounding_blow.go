...
func (c WoundingBlowRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c WoundingBlowYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c WoundingBlowBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
