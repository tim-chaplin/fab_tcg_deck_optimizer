...
func (c FyendalsFightingSpiritRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return fyendalsFightingSpiritDamage(c.Attack()) }
...
func (c FyendalsFightingSpiritYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return fyendalsFightingSpiritDamage(c.Attack()) }
...
func (c FyendalsFightingSpiritBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return fyendalsFightingSpiritDamage(c.Attack()) }
