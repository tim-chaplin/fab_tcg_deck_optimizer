...
func (c SirensOfSafeHarborRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() + 1 }
...
func (c SirensOfSafeHarborYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() + 1 }
...
func (c SirensOfSafeHarborBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() + 1 }
