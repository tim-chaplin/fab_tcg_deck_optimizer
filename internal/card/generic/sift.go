...
func (SiftRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return 0 }
...
func (SiftYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return 0 }
...
func (SiftBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return 0 }
