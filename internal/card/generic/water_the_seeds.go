...
func (c WaterTheSeedsRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return waterTheSeedsPlay(c.Attack(), s) }
...
func (c WaterTheSeedsYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return waterTheSeedsPlay(c.Attack(), s) }
...
func (c WaterTheSeedsBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return waterTheSeedsPlay(c.Attack(), s) }
