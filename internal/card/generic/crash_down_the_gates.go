...
func (c CrashDownTheGatesRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return crashDownTheGatesDamage(c.Attack()) }
...
func (c CrashDownTheGatesYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return crashDownTheGatesDamage(c.Attack()) }
...
func (c CrashDownTheGatesBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return crashDownTheGatesDamage(c.Attack()) }
