...
func (c WalkThePlankRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return walkThePlankDamage(c.Attack()) }
...
func (c WalkThePlankYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return walkThePlankDamage(c.Attack()) }
...
func (c WalkThePlankBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return walkThePlankDamage(c.Attack()) }
