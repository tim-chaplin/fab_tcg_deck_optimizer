...
func (c BrandishRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c BrandishYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c BrandishBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
