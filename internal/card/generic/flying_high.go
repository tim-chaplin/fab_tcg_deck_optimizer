...
func (FlyingHighRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return flyingHighPlay(s, 1) }
...
func (FlyingHighYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return flyingHighPlay(s, 2) }
...
func (FlyingHighBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return flyingHighPlay(s, 3) }
