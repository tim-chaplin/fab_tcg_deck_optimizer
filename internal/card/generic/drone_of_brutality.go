...
func (c DroneOfBrutalityRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c DroneOfBrutalityYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c DroneOfBrutalityBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
