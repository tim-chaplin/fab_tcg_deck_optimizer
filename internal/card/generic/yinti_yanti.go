...
func (c YintiYantiRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return yintiYantiPlay(c.Attack(), s) }
...
func (c YintiYantiYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return yintiYantiPlay(c.Attack(), s) }
...
func (c YintiYantiBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return yintiYantiPlay(c.Attack(), s) }
