...
func (c StrikeGoldRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return strikeGoldDamage(c.Attack()) }
...
func (c StrikeGoldYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return strikeGoldDamage(c.Attack()) }
...
func (c StrikeGoldBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return strikeGoldDamage(c.Attack()) }
