...
func (c MoneyOrYourLifeRed) Play(s *card.TurnState) int { return c.Attack() }
...
func (c MoneyOrYourLifeYellow) Play(s *card.TurnState) int { return c.Attack() }
...
func (c MoneyOrYourLifeBlue) Play(s *card.TurnState) int { return c.Attack() }
