...
func (c OverloadRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c OverloadYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c OverloadBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
