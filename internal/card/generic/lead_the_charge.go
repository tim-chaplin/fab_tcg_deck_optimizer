...
func (LeadTheChargeRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return 0 }
...
func (LeadTheChargeYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return 0 }
...
func (LeadTheChargeBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return 0 }
