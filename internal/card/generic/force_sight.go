...
func (ForceSightRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return nextAttackActionBonus(s, 3) }
...
func (ForceSightYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return nextAttackActionBonus(s, 2) }
...
func (ForceSightBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return nextAttackActionBonus(s, 1) }
