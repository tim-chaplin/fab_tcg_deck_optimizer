...
func (c LifeForALifeRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return lifeForALifeDamage(c.Attack()) }
...
func (c LifeForALifeYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return lifeForALifeDamage(c.Attack()) }
...
func (c LifeForALifeBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return lifeForALifeDamage(c.Attack()) }
