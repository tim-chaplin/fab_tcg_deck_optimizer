...
func (c NimbleStrikeRed) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c NimbleStrikeYellow) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
...
func (c NimbleStrikeBlue) Play(s *card.TurnState, _ *card.PlayedCard) int { return c.Attack() }
