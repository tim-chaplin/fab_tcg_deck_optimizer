...
func TestCardState_EffectiveGoAgain(t *testing.T) {
	...
	for _, tc := range cases {
		p := &CardState{
			...
			PerPerm: PerPerm{GrantedGoAgain: tc.granted},
		}
...
func TestCardState_EffectiveDominate(t *testing.T) {
	...
	for _, tc := range cases {
		p := &CardState{Card: tc.card, PerPerm: PerPerm{GrantedDominate: tc.granted}}
...
func TestCardState_EffectiveAttack(t *testing.T) {
	...
	for _, tc := range cases {
		p := &CardState{
			...
			PerPerm: PerPerm{BonusAttack: tc.bonusAttack},
		}
