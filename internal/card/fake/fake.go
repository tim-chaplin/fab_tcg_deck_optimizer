...
func (c BlueAttack) Play(*card.TurnState, *card.PlayedCard) int { return c.Attack() }
...
func (c RedAttack) Play(*card.TurnState, *card.PlayedCard) int { return c.Attack() }
...
func (c YellowAttack) Play(*card.TurnState, *card.PlayedCard) int { return c.Attack() }
...
func (c DrawCantrip) Play(s *card.TurnState, _ *card.PlayedCard) int {
	s.DrawOne()
	return c.Attack()
}
...
func (CostlyDraw) Play(s *card.TurnState, _ *card.PlayedCard) int { s.DrawOne(); return 0 }
...
func (c CostlyAttack) Play(*card.TurnState, *card.PlayedCard) int  { return c.Attack() }
...
func (PitchOneDR) Play(*card.TurnState, *card.PlayedCard) int   { return 0 }
...
func (c HugeAttack) Play(*card.TurnState, *card.PlayedCard) int { return c.Attack() }
