...
func (OutMuscleRed) Play(ge card.GameEngine, l card.Logger, self *card.CardState) {}

func (OutMuscleYellow) Play(ge card.GameEngine, l card.Logger, self *card.CardState) {}

func (OutMuscleBlue) Play(ge card.GameEngine, l card.Logger, self *card.CardState) {}
