...
func (CrashDownTheGatesRed) Cost(card.GameEngine) int           { return 3 }
...
func (CrashDownTheGatesYellow) Cost(card.GameEngine) int           { return 3 }
...
func (CrashDownTheGatesBlue) Cost(card.GameEngine) int           { return 3 }
