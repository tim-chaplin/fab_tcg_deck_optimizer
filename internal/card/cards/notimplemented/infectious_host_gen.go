...
func (InfectiousHostRed) Cost(card.GameEngine) int           { return 0 }
...
func (InfectiousHostYellow) Cost(card.GameEngine) int           { return 0 }
...
func (InfectiousHostBlue) Cost(card.GameEngine) int           { return 0 }
