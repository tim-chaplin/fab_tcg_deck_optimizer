...
func (c SeekHorizonRed) Play(ge card.GameEngine, l card.Logger, self *card.CardState) {
}

// not implemented: hand-on-top alt cost and conditional go-again rider

func (c SeekHorizonYellow) Play(ge card.GameEngine, l card.Logger, self *card.CardState) {
}

// not implemented: hand-on-top alt cost and conditional go-again rider

func (c SeekHorizonBlue) Play(ge card.GameEngine, l card.Logger, self *card.CardState) {
}
