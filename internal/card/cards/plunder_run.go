...
func plunderRunOnHitDraw(ge card.GameEngine, l card.Logger, t card.EphemeralTrigger, triggeringCard *card.CardState, _ triggertype.Type) {
	ge.DrawOne()
	l.AppendPostTriggerf(triggeringCard.Card.DisplayName(), 0,
