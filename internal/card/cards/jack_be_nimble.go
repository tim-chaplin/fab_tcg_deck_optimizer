...
func jackBeNimblePlay(ge card.GameEngine, l card.Logger, self *card.CardState) {
...
func (JackBeNimbleRed) Play(ge card.GameEngine, l card.Logger, self *card.CardState) {
	jackBeNimblePlay(ge, l, self)
}
