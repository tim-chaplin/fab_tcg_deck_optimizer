...
func (WoundingBlowRed) Cost(sim.GameEngine) int { return 0 }
...
func (WoundingBlowYellow) Cost(sim.GameEngine) int { return 0 }
...
func (WoundingBlowBlue) Cost(sim.GameEngine) int { return 0 }
