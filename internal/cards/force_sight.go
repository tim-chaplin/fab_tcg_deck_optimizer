...
//
// Modelling: arsenal-gated Opt 2 (deck-cycling cosmetic, no measurable EV) isn't modelled —
// the +N{p} grant on the next attack action card carries the card's value.
