...
func (SigilOfSufferingRed) Cost(sim.GameEngine) int { return 0 }
...
func (SigilOfSufferingYellow) Cost(sim.GameEngine) int { return 0 }
...
func (SigilOfSufferingBlue) Cost(sim.GameEngine) int { return 0 }
