...
func (OutMuscleRed) Cost(sim.GameEngine) int { return 3 }
...
func (OutMuscleYellow) Cost(sim.GameEngine) int { return 3 }
...
func (OutMuscleBlue) Cost(sim.GameEngine) int { return 3 }
