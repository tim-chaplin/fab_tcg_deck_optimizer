...
func (ZealousBeltingRed) Cost(sim.GameEngine) int { return 2 }
...
func (ZealousBeltingYellow) Cost(sim.GameEngine) int { return 2 }
...
func (ZealousBeltingBlue) Cost(sim.GameEngine) int { return 2 }
