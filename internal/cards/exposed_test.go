...
func TestExposed_AcceptsAttackAction(t *testing.T) {
	if !(ExposedBlue{}).ARTargetAllowed(nil, testutils.GenericAttack(0, 4), 0) {
...
func TestExposed_AcceptsWeaponAttack(t *testing.T) {
	if !(ExposedBlue{}).ARTargetAllowed(nil, testutils.RunebladeWeapon{}, 0) {
...
func TestExposed_RejectsNonAttack(t *testing.T) {
	if (ExposedBlue{}).ARTargetAllowed(nil, testutils.NonAttack{}, 0) {
