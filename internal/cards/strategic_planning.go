...
func (StrategicPlanningRed) Play(s *sim.TurnState, self *sim.CardState) { s.LogChain(self, 0) }
...
func (StrategicPlanningYellow) Play(s *sim.TurnState, self *sim.CardState) { s.LogChain(self, 0) }
...
func (StrategicPlanningBlue) Play(s *sim.TurnState, self *sim.CardState) { s.LogChain(self, 0) }
