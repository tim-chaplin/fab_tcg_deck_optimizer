...
func (EvasiveLeapRed) Play(s *card.TurnState, self *card.CardState) {
...
func (EvasiveLeapYellow) Play(s *card.TurnState, self *card.CardState) {
	s.ApplyAndLogEffectiveDefense(self)
}
...
func (EvasiveLeapBlue) Play(s *card.TurnState, self *card.CardState) {
	s.ApplyAndLogEffectiveDefense(self)
}
