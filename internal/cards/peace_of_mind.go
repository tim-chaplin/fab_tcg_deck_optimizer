...
func (PeaceOfMindRed) Play(s *sim.TurnState, self *sim.CardState) { s.LogPlay(self) }
...
func (PeaceOfMindYellow) Play(s *sim.TurnState, self *sim.CardState) { s.LogPlay(self) }
...
func (PeaceOfMindBlue) Play(s *sim.TurnState, self *sim.CardState) { s.LogPlay(self) }
