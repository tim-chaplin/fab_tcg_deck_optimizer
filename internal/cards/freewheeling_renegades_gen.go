...
func (FreewheelingRenegadesRed) Cost(card.GameEngine) int { return 1 }
...
func (FreewheelingRenegadesYellow) Cost(card.GameEngine) int { return 1 }
...
func (FreewheelingRenegadesBlue) Cost(card.GameEngine) int { return 1 }
