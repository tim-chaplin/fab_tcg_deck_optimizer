...
func (StrikeGoldRed) Cost(sim.GameEngine) int { return 0 }
...
func (StrikeGoldYellow) Cost(sim.GameEngine) int { return 0 }
...
func (StrikeGoldBlue) Cost(sim.GameEngine) int { return 0 }
