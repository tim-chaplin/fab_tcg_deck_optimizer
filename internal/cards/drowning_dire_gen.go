...
func (DrowningDireRed) Cost(sim.GameEngine) int { return 2 }
...
func (DrowningDireYellow) Cost(sim.GameEngine) int { return 2 }
...
func (DrowningDireBlue) Cost(sim.GameEngine) int { return 2 }
