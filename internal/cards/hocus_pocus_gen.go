...
func (HocusPocusRed) Cost(sim.GameEngine) int { return 0 }
...
func (HocusPocusYellow) Cost(sim.GameEngine) int { return 0 }
...
func (HocusPocusBlue) Cost(sim.GameEngine) int { return 0 }
