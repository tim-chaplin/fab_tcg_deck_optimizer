...
func (NimbyRed) Play(s *sim.TurnState, self *sim.CardState) { s.Log(self, 0) }

func (NimbyYellow) Play(s *sim.TurnState, self *sim.CardState) { s.Log(self, 0) }

func (NimbyBlue) Play(s *sim.TurnState, self *sim.CardState) { s.Log(self, 0) }
