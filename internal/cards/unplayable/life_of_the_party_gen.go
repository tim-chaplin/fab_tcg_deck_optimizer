...
func (LifeOfThePartyRed) Cost(card.GameEngine) int           { return 2 }
...
func (LifeOfThePartyYellow) Cost(card.GameEngine) int           { return 2 }
...
func (LifeOfThePartyBlue) Cost(card.GameEngine) int           { return 2 }
