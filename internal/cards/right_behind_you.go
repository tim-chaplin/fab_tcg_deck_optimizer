...
func (c RightBehindYouRed) Play(s *card.TurnState, self *card.CardState) {
...
func (c RightBehindYouYellow) Play(s *card.TurnState, self *card.CardState) {
	s.ApplyAndLogEffectiveAttack(self)
}
...
func (c RightBehindYouBlue) Play(s *card.TurnState, self *card.CardState) {
	s.ApplyAndLogEffectiveAttack(self)
}
