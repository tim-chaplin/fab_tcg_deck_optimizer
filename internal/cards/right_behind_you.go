...
//
// The deck-top peek/bottom rider is dropped: the optimizer would never bottom a card it'd
// rather draw next, so the rider collapses to a no-op.
...
func (RightBehindYouRed) DefendsTogetherBonus() int { return 1 }
...
func (RightBehindYouYellow) DefendsTogetherBonus() int { return 1 }
...
func (RightBehindYouBlue) DefendsTogetherBonus() int { return 1 }
