...
func (ArcanicSpikeRed) Cost(sim.GameEngine) int { return 2 }
...
func (ArcanicSpikeYellow) Cost(sim.GameEngine) int { return 2 }
...
func (ArcanicSpikeBlue) Cost(sim.GameEngine) int { return 2 }
