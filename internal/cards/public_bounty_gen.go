...
func (PublicBountyRed) Cost(card.GameEngine) int { return 1 }
...
func (PublicBountyYellow) Cost(card.GameEngine) int { return 1 }
...
func (PublicBountyBlue) Cost(card.GameEngine) int { return 1 }
