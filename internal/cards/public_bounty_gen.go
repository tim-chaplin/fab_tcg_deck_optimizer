...
func (PublicBountyRed) Cost(sim.GameEngine) int { return 1 }
...
func (PublicBountyYellow) Cost(sim.GameEngine) int { return 1 }
...
func (PublicBountyBlue) Cost(sim.GameEngine) int { return 1 }
