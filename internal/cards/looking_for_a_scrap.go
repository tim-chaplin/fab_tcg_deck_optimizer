...
func (c LookingForAScrapRed) Play(s *card.TurnState, self *card.CardState) {
...
func (c LookingForAScrapYellow) Play(s *card.TurnState, self *card.CardState) {
	s.ApplyAndLogEffectiveAttack(self)
}
...
func (c LookingForAScrapBlue) Play(s *card.TurnState, self *card.CardState) {
	s.ApplyAndLogEffectiveAttack(self)
}
