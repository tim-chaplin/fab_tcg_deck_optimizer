...
func (ForceSightRed) Cost(sim.GameEngine) int { return 1 }
...
func (ForceSightYellow) Cost(sim.GameEngine) int { return 1 }
...
func (ForceSightBlue) Cost(sim.GameEngine) int { return 1 }
