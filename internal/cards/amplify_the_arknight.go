...
func amplifyTheArknightCost(s sim.GameEngine) int {
...
func (AmplifyTheArknightRed) Cost(s sim.GameEngine) int { return amplifyTheArknightCost(s) }
...
func (AmplifyTheArknightRed) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {
}

func (AmplifyTheArknightYellow) Cost(s sim.GameEngine) int { return amplifyTheArknightCost(s) }
...
func (AmplifyTheArknightYellow) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {
}

func (AmplifyTheArknightBlue) Cost(s sim.GameEngine) int { return amplifyTheArknightCost(s) }
...
func (AmplifyTheArknightBlue) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {
}
