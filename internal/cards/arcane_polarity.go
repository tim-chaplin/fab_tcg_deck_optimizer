...
func (ArcanePolarityRed) Play(s *sim.TurnState, self *sim.CardState) { s.LogChain(self, 0) }
...
func (ArcanePolarityYellow) Play(s *sim.TurnState, self *sim.CardState) { s.LogChain(self, 0) }
...
func (ArcanePolarityBlue) Play(s *sim.TurnState, self *sim.CardState) { s.LogChain(self, 0) }
