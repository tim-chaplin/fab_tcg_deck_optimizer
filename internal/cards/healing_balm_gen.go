...
func (HealingBalmRed) Cost(sim.GameEngine) int { return 0 }
...
func (HealingBalmYellow) Cost(sim.GameEngine) int { return 0 }
...
func (HealingBalmBlue) Cost(sim.GameEngine) int { return 0 }
