...
func (EirinasPrayerRed) Play(s *sim.TurnState, self *sim.CardState) { s.LogChain(self, 0) }
...
func (EirinasPrayerYellow) Play(s *sim.TurnState, self *sim.CardState) { s.LogChain(self, 0) }
...
func (EirinasPrayerBlue) Play(s *sim.TurnState, self *sim.CardState) { s.LogChain(self, 0) }
