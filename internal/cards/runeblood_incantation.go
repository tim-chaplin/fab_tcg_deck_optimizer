...
func runebloodAuraHandler(s card.GameEngine, l card.Logger, _ *sim.Trigger, a *sim.Aura) {
...
func runebloodPlay(s card.GameEngine, l card.Logger, selfState *card.CardState, selfCard card.Card, n int) {
	s.AddAura(sim.Aura{
