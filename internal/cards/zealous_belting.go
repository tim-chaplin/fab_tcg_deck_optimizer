...
func zealousBeltingPlay(s sim.GameEngine, l sim.Logger, self *sim.CardState) {
...
func (ZealousBeltingRed) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {
	zealousBeltingPlay(s, l, self)
}

func (ZealousBeltingYellow) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {
	zealousBeltingPlay(s, l, self)
}

func (ZealousBeltingBlue) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {
	zealousBeltingPlay(s, l, self)
}
