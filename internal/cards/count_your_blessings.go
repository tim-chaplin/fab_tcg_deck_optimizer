...
func (CountYourBlessingsRed) Play(s *sim.TurnState, self *sim.CardState) { s.LogPlay(self) }
...
func (CountYourBlessingsYellow) Play(s *sim.TurnState, self *sim.CardState) { s.LogPlay(self) }
...
func (CountYourBlessingsBlue) Play(s *sim.TurnState, self *sim.CardState) { s.LogPlay(self) }
