...
func (c StonyWoottonhogRed) Play(s *card.TurnState, self *card.CardState) {
...
func (c StonyWoottonhogYellow) Play(s *card.TurnState, self *card.CardState) {
	s.ApplyAndLogEffectiveAttack(self)
}
...
func (c StonyWoottonhogBlue) Play(s *card.TurnState, self *card.CardState) {
	s.ApplyAndLogEffectiveAttack(self)
}
