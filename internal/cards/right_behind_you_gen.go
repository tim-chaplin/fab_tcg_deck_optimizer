...
func (RightBehindYouRed) Cost(sim.GameEngine) int { return 3 }
...
func (RightBehindYouYellow) Cost(sim.GameEngine) int { return 3 }
...
func (RightBehindYouBlue) Cost(sim.GameEngine) int { return 3 }
