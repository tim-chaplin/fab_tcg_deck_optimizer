...
func (PromiseOfPlentyRed) Cost(*sim.TurnState) int { return 0 }
...
func (PromiseOfPlentyYellow) Cost(*sim.TurnState) int { return 0 }
...
func (PromiseOfPlentyBlue) Cost(*sim.TurnState) int { return 0 }
