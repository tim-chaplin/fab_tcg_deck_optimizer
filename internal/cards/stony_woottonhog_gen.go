...
func (StonyWoottonhogRed) Cost(sim.GameEngine) int { return 2 }
...
func (StonyWoottonhogYellow) Cost(sim.GameEngine) int { return 2 }
...
func (StonyWoottonhogBlue) Cost(sim.GameEngine) int { return 2 }
