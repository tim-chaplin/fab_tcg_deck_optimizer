...
func (ReadTheRunesRed) Cost(card.GameEngine) int { return 0 }
...
func (ReadTheRunesYellow) Cost(card.GameEngine) int { return 0 }
...
func (ReadTheRunesBlue) Cost(card.GameEngine) int { return 0 }
