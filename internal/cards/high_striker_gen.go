...
func (HighStrikerRed) Cost(sim.GameEngine) int { return 0 }
...
func (HighStrikerYellow) Cost(sim.GameEngine) int { return 0 }
...
func (HighStrikerBlue) Cost(sim.GameEngine) int { return 0 }
