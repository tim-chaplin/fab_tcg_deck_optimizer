...
func (PickACardAnyCardRed) Play(s *sim.TurnState, self *sim.CardState) { s.LogChain(self, 0) }
...
func (PickACardAnyCardYellow) Play(s *sim.TurnState, self *sim.CardState) { s.LogChain(self, 0) }
...
func (PickACardAnyCardBlue) Play(s *sim.TurnState, self *sim.CardState) { s.LogChain(self, 0) }
