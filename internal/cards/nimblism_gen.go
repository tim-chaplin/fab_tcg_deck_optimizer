...
func (NimblismRed) Cost(sim.GameEngine) int { return 0 }
...
func (NimblismYellow) Cost(sim.GameEngine) int { return 0 }
...
func (NimblismBlue) Cost(sim.GameEngine) int { return 0 }
