...
func (BrothersInArmsRed) Cost(sim.GameEngine) int { return 2 }
...
func (BrothersInArmsYellow) Cost(sim.GameEngine) int { return 2 }
...
func (BrothersInArmsBlue) Cost(sim.GameEngine) int { return 2 }
