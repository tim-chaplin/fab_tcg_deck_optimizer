...
func (PummelRed) Play(s *sim.TurnState, self *sim.CardState) { s.LogChain(self, 0) }
...
func (PummelYellow) Play(s *sim.TurnState, self *sim.CardState) { s.LogChain(self, 0) }
...
func (PummelBlue) Play(s *sim.TurnState, self *sim.CardState) { s.LogChain(self, 0) }
