...
func (SpellbladeStrikeRed) Cost(sim.GameEngine) int { return 1 }
...
func (SpellbladeStrikeYellow) Cost(sim.GameEngine) int { return 1 }
...
func (SpellbladeStrikeBlue) Cost(sim.GameEngine) int { return 1 }
