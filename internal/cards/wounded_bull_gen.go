...
func (WoundedBullRed) Cost(card.GameEngine) int           { return 3 }
...
func (WoundedBullYellow) Cost(card.GameEngine) int           { return 3 }
...
func (WoundedBullBlue) Cost(card.GameEngine) int           { return 3 }
