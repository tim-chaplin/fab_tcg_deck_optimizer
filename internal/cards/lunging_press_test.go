...
func TestLungingPress_AcceptsAttackAction(t *testing.T) {
	if !(LungingPressBlue{}).ARTargetAllowed(testutils.GenericAttack(0, 0)) {
...
func TestLungingPress_RejectsNonAttackAction(t *testing.T) {
	if (LungingPressBlue{}).ARTargetAllowed(testutils.GenericAction()) {
...
func TestLungingPress_RejectsWeapon(t *testing.T) {
	...
	if (LungingPressBlue{}).ARTargetAllowed(weapon) {
