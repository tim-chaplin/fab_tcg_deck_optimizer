...
func (WhisperOfTheOracleRed) Cost(sim.GameEngine) int { return 0 }
...
func (WhisperOfTheOracleYellow) Cost(sim.GameEngine) int { return 0 }
...
func (WhisperOfTheOracleBlue) Cost(sim.GameEngine) int { return 0 }
