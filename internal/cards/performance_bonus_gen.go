...
func (PerformanceBonusRed) Cost(sim.GameEngine) int { return 0 }
...
func (PerformanceBonusYellow) Cost(sim.GameEngine) int { return 0 }
...
func (PerformanceBonusBlue) Cost(sim.GameEngine) int { return 0 }
