...
func (SiftRed) Play(s *sim.TurnState, self *sim.CardState) { s.LogChain(self, 0) }
...
func (SiftYellow) Play(s *sim.TurnState, self *sim.CardState) { s.LogChain(self, 0) }
...
func (SiftBlue) Play(s *sim.TurnState, self *sim.CardState) { s.LogChain(self, 0) }
