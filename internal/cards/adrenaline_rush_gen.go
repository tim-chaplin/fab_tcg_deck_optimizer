...
func (AdrenalineRushRed) Cost(sim.GameEngine) int { return 2 }
...
func (AdrenalineRushYellow) Cost(sim.GameEngine) int { return 2 }
...
func (AdrenalineRushBlue) Cost(sim.GameEngine) int { return 2 }
