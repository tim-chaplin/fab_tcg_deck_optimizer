...
func (OasisRespiteRed) Cost(sim.GameEngine) int { return 1 }
...
func (OasisRespiteYellow) Cost(sim.GameEngine) int { return 1 }
...
func (OasisRespiteBlue) Cost(sim.GameEngine) int { return 1 }
