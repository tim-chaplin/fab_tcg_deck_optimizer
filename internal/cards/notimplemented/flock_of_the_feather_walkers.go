...
func (c FlockOfTheFeatherWalkersRed) Play(ge card.GameEngine, l card.Logger, self *card.CardState) {
}

// not implemented: additional reveal cost, quicken tokens

func (c FlockOfTheFeatherWalkersYellow) Play(ge card.GameEngine, l card.Logger, self *card.CardState) {
}

// not implemented: additional reveal cost, quicken tokens

func (c FlockOfTheFeatherWalkersBlue) Play(ge card.GameEngine, l card.Logger, self *card.CardState) {
}
