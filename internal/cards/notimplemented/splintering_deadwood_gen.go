...
func (SplinteringDeadwoodRed) Cost(sim.GameEngine) int { return 3 }
...
func (SplinteringDeadwoodYellow) Cost(sim.GameEngine) int { return 3 }
...
func (SplinteringDeadwoodBlue) Cost(sim.GameEngine) int { return 3 }
