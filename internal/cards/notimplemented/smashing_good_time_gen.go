...
func (SmashingGoodTimeRed) Cost(sim.GameEngine) int { return 0 }
...
func (SmashingGoodTimeYellow) Cost(sim.GameEngine) int { return 0 }
...
func (SmashingGoodTimeBlue) Cost(sim.GameEngine) int { return 0 }
