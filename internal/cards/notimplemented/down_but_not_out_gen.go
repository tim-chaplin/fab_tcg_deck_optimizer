...
func (DownButNotOutRed) Cost(sim.GameEngine) int { return 3 }
...
func (DownButNotOutYellow) Cost(sim.GameEngine) int { return 3 }
...
func (DownButNotOutBlue) Cost(sim.GameEngine) int { return 3 }
