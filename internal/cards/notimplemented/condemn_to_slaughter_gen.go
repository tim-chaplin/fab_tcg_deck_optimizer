...
func (CondemnToSlaughterRed) Cost(sim.GameEngine) int { return 1 }
...
func (CondemnToSlaughterYellow) Cost(sim.GameEngine) int { return 1 }
...
func (CondemnToSlaughterBlue) Cost(sim.GameEngine) int { return 1 }
