...
func (FrontlineScoutRed) Cost(sim.GameEngine) int { return 0 }
...
func (FrontlineScoutYellow) Cost(sim.GameEngine) int { return 0 }
...
func (FrontlineScoutBlue) Cost(sim.GameEngine) int { return 0 }
