...
func (RiseAboveRed) Cost(*sim.TurnState) int { return 2 }
func (RiseAboveRed) Pitch() int              { return 1 }
func (RiseAboveRed) Attack() int             { return 0 }
func (RiseAboveRed) Defense() int            { return 4 }
func (RiseAboveRed) Types() card.TypeSet     { return cards.DefenseReactionTypes }
...
func (RiseAboveYellow) Cost(*sim.TurnState) int { return 2 }
func (RiseAboveYellow) Pitch() int              { return 2 }
func (RiseAboveYellow) Attack() int             { return 0 }
func (RiseAboveYellow) Defense() int            { return 3 }
func (RiseAboveYellow) Types() card.TypeSet     { return cards.DefenseReactionTypes }
...
func (RiseAboveBlue) Cost(*sim.TurnState) int { return 2 }
func (RiseAboveBlue) Pitch() int              { return 3 }
func (RiseAboveBlue) Attack() int             { return 0 }
func (RiseAboveBlue) Defense() int            { return 2 }
func (RiseAboveBlue) Types() card.TypeSet     { return cards.DefenseReactionTypes }
