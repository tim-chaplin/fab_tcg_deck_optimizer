...
func (ReinforceTheLineRed) Cost(sim.GameEngine) int { return 0 }
...
func (ReinforceTheLineYellow) Cost(sim.GameEngine) int { return 0 }
...
func (ReinforceTheLineBlue) Cost(sim.GameEngine) int { return 0 }
