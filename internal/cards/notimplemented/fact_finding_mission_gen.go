...
func (FactFindingMissionRed) Cost(sim.GameEngine) int { return 2 }
...
func (FactFindingMissionYellow) Cost(sim.GameEngine) int { return 2 }
...
func (FactFindingMissionBlue) Cost(sim.GameEngine) int { return 2 }
