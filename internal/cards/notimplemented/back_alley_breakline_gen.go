...
func (BackAlleyBreaklineRed) Cost(sim.GameEngine) int { return 1 }
...
func (BackAlleyBreaklineYellow) Cost(sim.GameEngine) int { return 1 }
...
func (BackAlleyBreaklineBlue) Cost(sim.GameEngine) int { return 1 }
