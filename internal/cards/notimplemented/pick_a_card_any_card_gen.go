...
func (PickACardAnyCardRed) Cost(sim.GameEngine) int { return 0 }
...
func (PickACardAnyCardYellow) Cost(sim.GameEngine) int { return 0 }
...
func (PickACardAnyCardBlue) Cost(sim.GameEngine) int { return 0 }
