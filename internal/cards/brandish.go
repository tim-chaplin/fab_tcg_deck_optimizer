...
func (c BrandishRed) Play(s *card.TurnState, self *card.CardState) {
...
func (c BrandishYellow) Play(s *card.TurnState, self *card.CardState) {
	s.ApplyAndLogEffectiveAttack(self)
}
...
func (c BrandishBlue) Play(s *card.TurnState, self *card.CardState) {
	s.ApplyAndLogEffectiveAttack(self)
}
