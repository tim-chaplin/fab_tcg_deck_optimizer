...
func (EvasiveLeapRed) Cost(sim.GameEngine) int { return 0 }
...
func (EvasiveLeapYellow) Cost(sim.GameEngine) int { return 0 }
...
func (EvasiveLeapBlue) Cost(sim.GameEngine) int { return 0 }
