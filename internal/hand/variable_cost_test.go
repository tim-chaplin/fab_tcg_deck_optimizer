...
// TestBest_DiscountAttackerPaysByPitchWithoutCarryover: a DiscountPerRunechant attack can be
...
// TestBest_DiscountDefenderPaysByPitchWithoutCarryover: a DiscountPerRunechant defense
