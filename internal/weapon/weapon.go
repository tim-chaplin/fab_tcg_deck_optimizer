...
// Weapon is an equipped permanent. Each turn the attack-turn runner enqueues the weapon's
// Ability() Card as a playable option (1 AP, pays the ability's printed activation cost);
// the weapon itself never enters the attack turn. Hands() is 1 or 2 for the "2 × 1H or 1 × 2H"
