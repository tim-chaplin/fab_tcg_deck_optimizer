...
func (RedPitch) Play(s *sim.TurnState, l sim.Logger, self *sim.CardState) {}
...
func (BluePitch) Play(s *sim.TurnState, l sim.Logger, self *sim.CardState) {}
...
func (InstantStub) Play(s *sim.TurnState, l sim.Logger, self *sim.CardState) {}
