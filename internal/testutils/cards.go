...
func (s Card) Cost(sim.GameEngine) int                       { return s.cost }
...
func (Card) Play(sim.GameEngine, sim.Logger, *sim.CardState) {}
...
func (RunebladeAttack) Cost(sim.GameEngine) int { return 0 }
...
func (RunebladeAttack) Play(sim.GameEngine, sim.Logger, *sim.CardState) {}
...
func (RunebladeWeapon) Cost(sim.GameEngine) int { return 0 }
...
func (RunebladeWeapon) Play(sim.GameEngine, sim.Logger, *sim.CardState) {}
...
func (NonAttack) Cost(sim.GameEngine) int                         { return 0 }
...
func (NonAttack) Play(sim.GameEngine, sim.Logger, *sim.CardState) {}
...
func (NonRunebladeAttack) Cost(sim.GameEngine) int { return 0 }
...
func (NonRunebladeAttack) Play(sim.GameEngine, sim.Logger, *sim.CardState) {}
...
func (AttackWithPower) Cost(sim.GameEngine) int { return 0 }
...
func (AttackWithPower) Play(sim.GameEngine, sim.Logger, *sim.CardState) {}
...
func (Aura) Cost(sim.GameEngine) int                         { return 0 }
...
func (Aura) Play(sim.GameEngine, sim.Logger, *sim.CardState) {}
...
func (RedPitch) Cost(sim.GameEngine) int { return 0 }
...
func (RedPitch) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {}
...
func (BluePitch) Cost(sim.GameEngine) int { return 0 }
...
func (BluePitch) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {}
...
func (BlueAttack) Cost(sim.GameEngine) int { return 1 }
...
func (BlueAttack) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {
}
...
func (RedAttack) Cost(sim.GameEngine) int { return 1 }
...
func (RedAttack) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {
}
...
func (YellowAttack) Cost(sim.GameEngine) int { return 1 }
...
func (YellowAttack) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {
}
...
func (CostlyDraw) Cost(sim.GameEngine) int { return 1 }
...
func (CostlyDraw) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {
	s.DrawOne()
}
...
func (CostlyAttack) Cost(sim.GameEngine) int { return 1 }
...
func (CostlyAttack) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {
}
...
func (PitchOneDR) Cost(sim.GameEngine) int { return 0 }
...
func (PitchOneDR) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {
}
...
func (HugeAttack) Cost(sim.GameEngine) int { return 0 }
...
func (HugeAttack) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {
}
...
func (StubCard) Cost(sim.GameEngine) int                         { return 0 }
...
func (StubCard) Play(sim.GameEngine, sim.Logger, *sim.CardState) {}
...
func (InstantStub) Cost(sim.GameEngine) int { return 0 }
...
func (InstantStub) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {}
...
func (NoGoAgainAttackStub) Cost(sim.GameEngine) int { return 0 }
...
func (NoGoAgainAttackStub) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {
}
...
func (GrantAll) Cost(sim.GameEngine) int { return 0 }
...
func (GrantAll) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {
...
func (GrantSpy) Cost(sim.GameEngine) int { return 0 }
...
func (g GrantSpy) Play(s sim.GameEngine, l sim.Logger, self *sim.CardState) {
...
func FireOnHitIfLikely(s sim.GameEngine, l sim.Logger, self *sim.CardState) {
