...
// without interaction between multiple drawn cards. Uses the same heroStub helper as
// hand_stubs_test.go (sim importing testutils would cycle through sim's test binary).
var int1StubHero = heroStub{intel: 1}
