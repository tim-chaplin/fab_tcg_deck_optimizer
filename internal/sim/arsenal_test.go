...
func TestBest_ArsenalInNonAttackActionPlays(t *testing.T) {
	h := []Card{cards.MaleficIncantationBlue{}}
	got := Best(testutils.Hero{Intel: 4}, nil, h, Matchup{IncomingDamage: 0}, nil, cards.ArcaneCussingRed{}, nil, nil)
	if got.Value != 3 {
...
func TestBest_ArsenalInUnmovableGrantsDefenseBonus(t *testing.T) {
	h := []Card{cards.MaleficIncantationBlue{}}
	got := Best(testutils.Hero{Intel: 4}, nil, h, Matchup{IncomingDamage: 8}, nil, cards.UnmovableRed{}, nil, nil)
	if got.Value != 8 {
...
func TestBest_HandUnmovableNoDefenseBonus(t *testing.T) {
	...
	got := Best(testutils.Hero{Intel: 4}, nil, h, Matchup{IncomingDamage: 8}, nil, nil, nil, nil)
	if got.Value != 7 {
...
func TestBest_ArsenalInSmashingGoodTimeGatesOnlyArsenalCopy(t *testing.T) {
	...
	got := Best(heroes.Viserai{}, nil, h, Matchup{IncomingDamage: 0}, nil, notimpl.SmashingGoodTimeRed{}, nil, nil)
	if got.Value != 8 {
